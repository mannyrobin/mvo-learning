...
?>
<div class="pp-content-post pp-content-grid-post<?php echo $alternate_class; ?> pp-grid-<?php echo $settings->post_grid_style_select; ?> <?php echo join( ' ', get_post_class() ); ?>" itemscope itemtype="<?php PPContentGridModule::schema_itemtype(); ?>" data-id="<?php echo $post_id; ?>">
