...
/**
 * POPMAKE DB base class
 *
 * @package     POPMAKE
 * @subpackage  Classes/POPMAKE DB
 * @copyright   Copyright (c) 2015, Daniel Iser
 * @license     http://opensource.org/licenses/gpl-2.0.php GNU Public License
 * @since       2.1
*/
abstract class POPMAKE_DB {
	...
	public function insert( $data, $type = '' ) {
		...
		do_action( 'popmake_pre_insert_' . $type, $data );
		...
		do_action( 'popmake_post_insert_' . $type, $wpdb->insert_id, $data );
